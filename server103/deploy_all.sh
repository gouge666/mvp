...
# 各服务器 IP
SERVER101_HOST="192.168.10.1"
SERVER102_HOST="192.168.10.2"
SERVER103_HOST="192.168.10.3"
SERVER104_HOST="192.168.10.4"

# 远端部署根目录
REMOTE_BASE="/home/user/common"

# pip 源（默认使用 10.2 上的 pypiserver）
PIP_INDEX_URL="${PIP_INDEX_URL:-http://192.168.10.2:8087/simple/}"
PIP_TRUSTED_HOST="${PIP_TRUSTED_HOST:-192.168.10.2}"
